...
type EventRow = {
  ...
  venue: string; address: string; city: string; landmark: string | null; banner_color: string;
    ...
    const { data, error } = await db
      ...
      .select(`
        ...
        event:events!tickets_event_id_fkey(
          id, event_name, category, date, time, venue, address, city, landmark, banner_color,
